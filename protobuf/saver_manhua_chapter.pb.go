...
func (*SaverManhuaChapter) Descriptor() ([]byte, []int) {
	return fileDescriptor_saver_manhua_chapter_78b9d8cc87fa6ae3, []int{0}
}
...
func init() {
	proto.RegisterFile("protobuf/saver_manhua_chapter.proto", fileDescriptor_saver_manhua_chapter_78b9d8cc87fa6ae3)
}

var fileDescriptor_saver_manhua_chapter_78b9d8cc87fa6ae3 = []byte{
